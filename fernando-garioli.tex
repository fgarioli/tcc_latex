...
\titulo{DESENVOLVIMENTO DE APLICATIVO PARA PROMOVER INTEGRAÇÃO\\
ENTRE PAIS E ALUNOS NO CONTEXTO EDUCACIONAL}
...
% \includepdf[pages=-]{resources/ficha.pdf}
\include{outros/aprovacao}
\include{outros/declaracao_autor}
...
% \include{listas/lista_algoritmos}
